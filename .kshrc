...
alias adb='sudo adb'
alias tasks='vim ~/Documents/tasks/tasks.txt'
alias bkk='vim ~/Documents/tasks/bkk.txt'
alias svi='sudo vim'
alias svim='sudo vim'
...
export accentum='80:C3:BA:5D:BA:53'
